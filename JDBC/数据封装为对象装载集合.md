...
### 练习：定义一个方法，查询test表中的数据将其封装为对象，然后装载集合并且返回

#### 数据库中的数据

![](https://picture.hs-vae.com/数据封装对象png)
...
//输出结果
test{id=1, name='hs', price=15.0}
test{id=2, name='yg', price=20.0}
test{id=3, name='lz', price=30.0}
test{id=4, name='wzk', price=40.0}
test{id=5, name='vae', price=50.0}
5
